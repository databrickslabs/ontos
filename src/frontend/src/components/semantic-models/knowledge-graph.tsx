...
interface KnowledgeGraphProps {
  ...
  selectedLanguage?: string;
  // Editing UX (port from PR #201 — graph-based ontology editing)
  onNodeRightClick?: (concept: OntologyConcept, event: MouseEvent) => void;
  onBackgroundRightClick?: (event: MouseEvent) => void;
  // When set, the graph enters link-draw mode: clicking another node calls onLinkDraw
  // with the source (this iri) and target (the clicked concept). Escape or background
  // click calls onLinkDrawCancel.
